...
class Character {
 ...
 public:
  ...
  inline const int getDamage() const {
    return rand() % (this->damageMax + this->weapon.getDamageMax()) +
           (this->damageMin + this->weapon.getDamageMin());
  }
  inline const int& getDefence() const { return this->defence; }
  inline const int getAddedDefence() const {
    return this->armor_arms.getDefence() + this->armor_chest.getDefence() +
           this->armor_legs.getDefence() + this->armor_head.getDefence();
  }
